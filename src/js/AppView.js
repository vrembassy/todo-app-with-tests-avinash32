...
(function(){
	...
	function AppView(){
		...
		document.body.addEventListener("checked",this.listenForcheckbox,false);
		document.body.addEventListener("unchecked",this.listenForcheckbox,false);
	...
	AppView.prototype.listenForcheckbox = function(e){
